			...
			<div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
				{committees.map((committee, index) => (
					<Link
						...
						className="group relative block w-full rounded-[2.5rem] p-[2px] overflow-hidden transition-[box-shadow,transform] duration-300 hover:shadow-[0_0_40px_rgba(37,99,235,0.15)] dark:hover:shadow-[0_0_40px_rgba(59,130,246,0.1)] hover:-translate-y-2 bg-zinc-200 dark:bg-zinc-800"
						style={{
					...
					>
						...
						<Card className="relative bg-white dark:bg-zinc-950 rounded-[calc(2.5rem-2px)] overflow-hidden h-full flex flex-col items-center justify-center border-none">
							...
							<div className="p-10 w-full flex justify-center relative z-10">
								<div className="relative h-48 w-48 transition-[transform,filter] duration-300 ease-out group-hover:scale-105 group-hover:drop-shadow-2xl transform-gpu">
									<Image
										src={committee.image}
										alt={committee.title}
										fill
										className="object-contain drop-shadow-sm transition-[filter] duration-300 filter group-hover:brightness-110"
							...
							<CardContent className="px-8 pb-10 pt-4 text-center w-full relative z-10 flex flex-col items-center">
								...
								<div className="mt-2 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-900 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 text-zinc-400 dark:text-zinc-600 group-hover:text-white transition-all duration-500 shadow-sm group-hover:shadow-blue-500/50 group-hover:w-40">
									...
									<span className="text-xl leading-none transition-transform duration-500 group-hover:translate-x-1">
										&rarr;
									</span>
								</div>
							</CardContent>
